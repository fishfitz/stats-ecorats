<template>
  <div>
    ...
    <div class="section content">
      ...
      <ul>
        <li> Le transport compte pour assez peu des émissions de gaz à effet de serre liées à l'alimentation, environ 5%. L'impact du transport est encore plus petit (moins d'1%) pour la viande de boeuf. </li>
        <li> Consommer local peut même augmenter les émissions. Importer est parfois moins émetteur que de cultiver en serre des produits hors-saison
